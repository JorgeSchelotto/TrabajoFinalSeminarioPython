...
j3_folder = os.path.join(os.path.join(os.path.join(game_folder, "Imagenes"), "j3"), "logo_J3.png")
...
class Main:
    ...
    def execute(self):
        ...
        self.on_init()
        iconos = [Icono('j1', j1_folder, 240, 610), Icono('j2', j2_folder, 540, 610), Icono('j3',j3_folder, 840, 610), Icono('j4', j4_folder, 1140, 610), Icono('quit', os.path.join(img_folder, "quit_suite.png"), 1250, 100 )]
        escenas = []
        while self.running:
